...
function custom_gettext($translated, $text, $domain)
{
  $custom_translates = array(
    'default' => array(
      ...
      '投稿を検索' => '制作実績を検索',
      '投稿を表示' => '制作実績を表示',
      '投稿は見つかりませんでした。' => '制作実績は見つかりませんでした。',
      'ゴミ箱内に投稿が見つかりませんでした。' => 'ゴミ箱内に制作実績は見つかりませんでした。',
      '投稿を更新しました。<a href="%s">投稿を表示する</a>' => '制作実績を更新しました。<a href="%s">制作実績を表示する</a>',
      'この投稿を先頭に固定表示' => 'この制作実績を先頭に固定表示'
    )
  );
